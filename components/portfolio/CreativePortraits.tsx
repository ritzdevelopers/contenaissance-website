            ...
            <div className="relative flex flex-col md:flex-row gap-10 md:gap-16 mx-auto px-6 sm:px-10 md:px-20 pb-52 md:pb-72 lg:pb-80 w-full">
               ...
               <img
                ...
                <img
                    ...
                    className="absolute top-[64%] md:top-[62%] lg:top-[62%] xl:top-80 left-[37%] md:left-[37%] lg:left-[29%] xl:left-[29%] 
                    w-28 sm:w-36 md:w-47 lg:w-48 xl:w-60 shadow-2xl rotate-[-8deg]"
                />
                ...
                <img
                    ...
                    className="absolute top-[46%] sm:top-[44%] md:top-47 lg:top-48 xl:top-44 left-[66%] sm:left-[62%] lg:left-[49%] xl:left-[50%] w-28 sm:w-36 md:w-50 lg:w-54 xl:w-60 shadow-2xl rotate-[-9deg]"
                />
                ...
                <img
                    ...
                    className="hidden lg:block absolute top-[74%] md:top-[50%] right-4 sm:right-10 md:right-20 w-28 sm:w-36 md:w-52 lg:w-52 xl:w-60 shadow-2xl rotate-[-8deg]"
                />
